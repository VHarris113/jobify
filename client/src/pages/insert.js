      ...
      <div style={{ display: "block", width: 950, padding: 30 }}>
        <Form onSubmit={handleSubmit}>
          <Form.Group>
            ...
            <Form.Control required onChange={jobUpdate} name = "company" type="text" placeholder="Company:" />
          </Form.Group>
          <Form.Group>
            <Form.Label></Form.Label>
            <Form.Control required onChange={jobUpdate} name = "title" type="text" placeholder="Job Title" />
          </Form.Group>
          <Form.Group>
            <Form.Label></Form.Label>
            <Form.Control required onChange={jobUpdate}  name = "location " type="text" placeholder="Location" />
          </Form.Group>
          <Form.Group>
            <Form.Label></Form.Label>
            <Form.Control required onChange={jobUpdate}  name = "salary" type="number" placeholder="Salary" />

          </Form.Group>
          <Form.Group>
            <Form.Label></Form.Label>
            <Form.Control onChange={jobUpdate}  name="url" type="link" placeholder="Listing URL" />
          </Form.Group>
          <Form.Group>
            <Form.Label></Form.Label>
            <Form.Control required onChange={jobUpdate}  name = "applied" type="text" placeholder="Date Applied" />
          </Form.Group>
          <Form.Group>
            <Form.Label></Form.Label>
            <Form.Control required onChange={jobUpdate}  name = "followed" type="text" placeholder="Follow Up Date" />
